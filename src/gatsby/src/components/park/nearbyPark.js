        ...
        photos.length === 1 && (
          <div className="park-image-div-mobile">
            <img
              ...
              onError={() => handleImgError(setErrorStates, 0, addSmallImagePrefix(photos[0].imageUrl))}
            />
          </div>
        )}
      {photos &&
                  ...
                  return (
                    ...
                    >
                      <img
                        ...
                        onError={() => handleImgError(setErrorStates, index, addSmallImagePrefix(item.imageUrl))}
                      />
                    </Carousel.Item>
                  )
                }
