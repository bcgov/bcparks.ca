...
function buildPayload(paAudit) {
  ...
  return {
    ...
    is_reservations_affected: paAudit.isReservationsAffected ?? false,
    is_advisory_date_displayed: paAudit.isAdvisoryDateDisplayed ?? false,
    is_effective_date_displayed: paAudit.isEffectiveDateDisplayed ?? false,
    is_end_date_displayed: paAudit.isEndDateDisplayed ?? false,
    is_updated_date_displayed: paAudit.isUpdatedDateDisplayed ?? false,
