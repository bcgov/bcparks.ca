                  ...
                  <div className="col-12 col-lg-9 col-md-10 d-flex">
                    ...
                    >
                      <Select
                        ...
                        onBlur={() => validateLink(l, setLinkTypeError)}
                      />
                ...
                <div className="row">
                  ...
                  <div className="col-12 col-lg-9 col-md-10">
                    <TextField
                      ...
                      onBlur={() => validateLink(l, setLinkTitleError)}
                    />
                  </div>
                </div>
                {l.format !== "file" ? (
                  <div className="row">
                    ...
                    <div className="col-12 col-lg-9 col-md-10">
                      <TextField
                        ...
                        onBlur={() => validateLink(l, setLinkUrlError)}
                        InputProps={{
                          ...linkUrlInput,
                          endAdornment: (
                            <IconButton
                  ...
                  <div className="row">
                    ...
                    <div className="col-12 col-lg-9 col-md-8 ad-flex">
                      ...
                      <TextField
                        ...
                        error={linkFileError}
                        helperText={linkFileError && "Please enter file too"}
                        onBlur={() => validateLink(l, setLinkFileError)}
                        InputProps={{
                          endAdornment: (
                            <IconButton
                              onClick={(e) => {
