    ...
    <div className="container-fluid px-0">
      ...
      <div className="park-search">
        ...
        <div className="park-search-carousel">
          ...
          <div
            className="col-12 d-none d-sm-block text-center text-white"
            id="carousel-down"
          >
...
function AdvisoryBar() {
  return (
    <>
      <div
        className="alert alert-warning alert-dismissable rounded-0 d-block d-sm-none"
        role="alert"
        id="home-alert"
      >
        ...
        <div className="row">
          ...
          <div className="col-11 align-self-center">
            <span className="text-center">
              Some parks are currently affected by wildfire activity.{" "}
              <a href="/" className="d-inline-flex underline">
                See all advisories
              </a>
              .
            </span>
      ...
      <div
        className="alert alert-warning alert-dismissable rounded-0 d-none d-sm-block"
        role="alert"
        id="home-alert"
      >
        <button type="button" className="close" data-dismiss="alert">
        ...
        <span className="text-center">
          <img
            className="alert-exclamation d-inline-flex pr-4"
            src={Exclamation}
            alt="exclamation"
          />
          Some parks are currently affected by wildfire activity.{" "}
