...
```sh
# dev:
helm -n c1643c-dev install crunchy . -f values-dev.yaml

# alpha dev:
helm -n c1643c-dev install crunchy-alpha . -f values-alpha-dev.yaml
```
...
```sh
# test
helm -n c1643c-test install crunchy . -f values-test.yaml

# alpha test:
helm -n c1643c-test install crunchy-alpha . -f values-alpha-test.yaml
```

### Prod

```sh
helm -n c1643c-prod install crunchy . -f values-prod.yaml
```
...
```sh
# dev:
helm -n c1643c-dev upgrade crunchy . -f values-dev.yaml

# alpha-dev:
helm -n c1643c-dev upgrade crunchy-alpha . -f values-alpha-dev.yaml
```
...
```sh
# test:
helm -n c1643c-test upgrade crunchy . -f values-test.yaml

# alpha-test:
helm -n c1643c-test upgrade crunchy-alpha . -f values-alpha-test.yaml
```

### Prod

```sh
helm -n c1643c-prod upgrade crunchy . -f values-prod.yaml
```
...
```sh
# dev:
helm -n c1643c-dev uninstall crunchy

# alpha-dev:
helm -n c1643c-dev uninstall crunchy-alpha
```
...
```sh
# test:
helm -n c1643c-test uninstall crunchy

# alpha-test:
helm -n c1643c-test uninstall crunchy-alpha
```
